// import { getProductById } from '@/services/productService'; // Revisa que esta ruta sea la correcta para ti
...
//               <button className="toCartDescription">Add to cart</button>
//               <button className="buyNow">Buy now</button>
//             </div>
//           </div>
//         </div>
//         <div>Evaluacion de la tienda 4.70/5</div>
//         <div>
//           <p>Reseñas</p>
//           <div>
//             <p>five starts</p>
